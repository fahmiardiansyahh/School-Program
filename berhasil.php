...
<body>
    ...
    <div class="navbar navbar-inverse">
        <div class="container">
            <div class="navbar-header">
                ...
                <marquee>  SELAMAT DATANG DI WEBSITE SEKOLAH SD NEGERI 1 BOGOR</marquee></a> 
            </div>
  ...
  <div class="container">
    <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="grey-box-icon b4">  
                            <h4>SELAMAT</h4>
                            <p>ANDA TELAH BERHASIL MENDAFTAR SILAHKAN KLIK DIBAWAH INI UNTUK MELIHAT PENGUMUMAN </p>
    ...
    <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="grey-box-icon b4">  
                            <p>SILAHKAN KLIK DIBAWAH INI UNTUK MASUK KE AKUN ANDA</p>
                            <p><a href="./masuk.php"><em>Masuk→</em></a></p>
                        </div><!--grey box -->
                    </div><!--/span3-->
                </div>
    </div>
